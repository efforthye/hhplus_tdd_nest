...
describe('PointValidationService', () => {
    ...
    // 너무 적은 금액의 충전은 시스템 리소스 낭비를 방지하기 위함
    ...
    // 포인트 사용 시 잔고가 부족하면 오류를 발생시켜 시스템 무결성을 보장하기 위함
    it('잔액 부족 시 예외 발생', () => {
    ...
    // 너무 적은 포인트 사용을 방지하고 시스템의 효율성을 유지하기 위함
